        ...
        <div className="flex-grow">
              ...
              <div className="grid grid-cols-6 gap-6">
                ...
                <div className="col-span-2">
                  ...
                  <div>
                    <form className="flex">
                      <input
                        className="bg-[#F9F9F9] py-4 px-2 rounded-[5px] border border-[#E6E6E6]"
                        placeholder="Your Email"
                        type="text"
                      />
                      <button
                        className="bg-[#23A6F0] p-4 text-white rounded-[5px]"
                        type="submit"
                      >
                        Subscribe
                      </button>
                    </form>
                    <div>Lore imp sum dolor Amit</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#FAFAFA]">
            <div className="max-w-[1050px] mx-auto h-[75px] flex items-center">
              <p className="m-0 p-0">
                Made With Love By Muhammad Taha All Right Reserved{" "}
              </p>
            </div>
          </div>
        </div>
